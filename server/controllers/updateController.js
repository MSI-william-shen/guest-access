...
// Helper function to keep our API calls DRY
        ...
        const response = await axios.post(
            ...
            { query, variables },
            {
                headers: {
                    ...
                    'API-Version': '2024-01' // Best practice: pin your API version
                }
            }
        );

        // If monday's GraphQL parser throws an error, catch it
...
exports.getBoardLayout = async (req, res) => {
    ...
    // We use GraphQL variables ($boardId) to safely inject dynamic data
    const query = `
